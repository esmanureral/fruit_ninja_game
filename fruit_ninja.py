...
class FruitNinjaView:
    ...
    def draw_shadow_text(self, screen, text_surface, rect, offset=(3, 3)):
    ...
    def draw(self):
        ...
        if game.combo_display_timer > 0 and game.combo_text_info:
            ...
            for txt, r in [(text1, rect1), (text2, rect2), (text3, rect3)]:
                self.draw_shadow_text(screen, txt, r)
...
class FruitNinjaViewModel:
    def __init__(self):
        ...
        # Load fruit images
        self.fruit_images = utils.load_fruit_images()
        ...
        self.wood_texture = utils.create_wood_texture()
